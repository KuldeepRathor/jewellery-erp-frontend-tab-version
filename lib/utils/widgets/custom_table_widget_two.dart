...
class CustomTableWidgetTwo extends StatefulWidget {
  const CustomTableWidgetTwo({
    super.key,
  ...
  @override
  State<CustomTableWidgetTwo> createState() => _CustomTableWidgetTwoState();
}

class _CustomTableWidgetTwoState extends State<CustomTableWidgetTwo> {
  @override
