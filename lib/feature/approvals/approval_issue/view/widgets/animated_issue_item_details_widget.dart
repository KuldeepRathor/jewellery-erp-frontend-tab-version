...
class AnimatedIssueItemDetailsWidget extends StatefulWidget {
  final bool isVisible;
  final VoidCallback onClose;

  const AnimatedIssueItemDetailsWidget({
    super.key,
  ...
  @override
  AnimatedIssueItemDetailsWidgetState createState() =>
      AnimatedIssueItemDetailsWidgetState();
}

class AnimatedIssueItemDetailsWidgetState
    extends State<AnimatedIssueItemDetailsWidget> {
  final ApprovalIssueItemDetailsController approvalItemDetailsController =
      Get.find<ApprovalIssueItemDetailsController>();
