...
// class ApprovalIssuePartyDetailsController extends GetxController {
...
//           await partyDetailsRepository.searchCustomer(query);
...
//         partDetailsCombined.addAll(customerResponse.values!
//             .where((customer) =>
...
//     if (!partyDetails.any((party) =>
//         party is CustomerSearchValue && party.id == newCustomer.id)) {
