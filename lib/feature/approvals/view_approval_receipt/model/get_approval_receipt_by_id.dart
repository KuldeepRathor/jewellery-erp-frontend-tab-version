...
class GetApprovalReceiptByIdResponse {
  String? id;
  String? approvalReceiptNumber;
  String? partyId;
  String? partyType;
  PartyDetails? partyDetails;
  DateTime? receiptDate;
  String? remarks;
  List<GetApprovalReceiptByIdLineItem>? lineItems;

  GetApprovalReceiptByIdResponse({
    this.id,
    this.approvalReceiptNumber,
    this.partyId,
    this.partyType,
    this.partyDetails,
    this.receiptDate,
  ...
  factory GetApprovalReceiptByIdResponse.fromRawJson(String str) =>
      GetApprovalReceiptByIdResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetApprovalReceiptByIdResponse.fromJson(Map<String, dynamic> json) =>
      GetApprovalReceiptByIdResponse(
        id: json["id"],
        approvalReceiptNumber: json["approval_receipt_number"],
        ...
        lineItems: json["line_items"] == null
            ? []
            : List<GetApprovalReceiptByIdLineItem>.from(json["line_items"]!
                .map((x) => GetApprovalReceiptByIdLineItem.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "id": id,
        "approval_receipt_number": approvalReceiptNumber,
        "party_id": partyId,
...
class GetApprovalReceiptByIdLineItem {
  dynamic ornamentId;
  dynamic counterId;
  dynamic stockHeadId;
  String? code;
  ...
  GetApprovalReceiptByIdLineItem({
    this.ornamentId,
    this.counterId,
    this.stockHeadId,
    this.code,
  ...
  factory GetApprovalReceiptByIdLineItem.fromRawJson(String str) =>
      GetApprovalReceiptByIdLineItem.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetApprovalReceiptByIdLineItem.fromJson(Map<String, dynamic> json) =>
      GetApprovalReceiptByIdLineItem(
