...
class ViewApprovalIssueItemDetailsWidget extends StatelessWidget {
  final GetApprovalIssueByIdResponse data;

  ViewApprovalIssueItemDetailsWidget({super.key, required this.data});
