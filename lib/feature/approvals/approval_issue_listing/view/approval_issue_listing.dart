...
import 'package:jewellery_erp_frontend_tab_version/feature/approvals/approval_issue_listing/view_model/approval_issue_listing_controller.dart';
...
class ApprovalIssueListingPage extends StatefulWidget {
  const ApprovalIssueListingPage({super.key});

  @override
  State<ApprovalIssueListingPage> createState() =>
      _ApprovalIssueListingPageState();
}

class _ApprovalIssueListingPageState extends State<ApprovalIssueListingPage> {
  final ApprovalIssueListingController controller = Get.put(
    ApprovalIssueListingController(),
  );
          ...
          children: [
            KeyboardListener(
              ...
              child: Column(
                ...
                children: [
                  HeaderWidget(header: 'Approval Issue Listing'),
                  Expanded(
                    child: Padding(
  ...
  void onNewMaterialInTap() {
    ...
    sidebarController.navigateToWidget(newChild: const ApprovalIssuePage());
  }
  ...
  Widget _buildApprovalListTable(ApprovalIssueListingController controller) {
    return Expanded(
      child: Container(
