...
class ApprovalListingRequest {
  ...
  factory ApprovalListingRequest.fromRawJson(String str) =>
      ApprovalListingRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ApprovalListingRequest.fromJson(Map<String, dynamic> json) =>
      ApprovalListingRequest(
