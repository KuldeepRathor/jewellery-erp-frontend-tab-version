...
import 'package:jewellery_erp_frontend_tab_version/feature/advance_booking/setup_advance_booking/view/setup_booking_page.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/advance_booking/new_booking/view/new_booking_page.dart';
...
class SetupBookingIntent extends Intent {
  const SetupBookingIntent();
}
...
class _BookingListPageState extends State<BookingListPage> {
  ...
  final BookingListingViewModel controller = Get.put(BookingListingViewModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ActionScopeWidget(
        onNewButtonTap: onNewBookingTap,
        additionalShortcuts: {
          LogicalKeySet(
        ...
        additionalActions: {
          SetupBookingIntent: CallbackAction<SetupBookingIntent>(
            onInvoke: (intent) {
              // Handle search
              onSetupBookingTap();
              return null;
        ...
        child: Column(
          ...
          children: [
            HeaderWidget(header: 'Booking List'),
            Expanded(
              child: Padding(
  ...
  Widget _buildActionBar() {
    return Row(
      children: [
        ...
        const Spacer(),
        CustomButton2(
          onTap: onSetupBookingTap,
          image: 'assets/svgs/add.svg',
          buttonName: 'Setup Advance Booking',
        ),
        const SizedBox(width: 16),
        CustomButton2(
  ...
  void onSetupBookingTap() {
    SidebarController sidebarController = Get.find();
    sidebarController.navigateToWidget(newChild: const SetupBookingPage());
  }

  void onNewBookingTap() {
    SidebarController sidebarController = Get.find();
    sidebarController.navigateToWidget(newChild: const NewBookingPage());
  }
  ...
  Widget _buildCustomerTable(BookingListingViewModel controller) {
    return Expanded(
      child: Container(
