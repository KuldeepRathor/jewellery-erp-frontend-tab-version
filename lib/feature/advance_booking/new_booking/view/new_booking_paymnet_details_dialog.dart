...
import 'package:jewellery_erp_frontend_tab_version/feature/advance_booking/new_booking/view_model/new_booking_paymnet_controller.dart';
...
class NewBookingPaymentDetailsTableData {
  ...
  NewBookingPaymentDetailsTableData({
...
class NewBookingPaymentDetailsDialog extends StatefulWidget {
  const NewBookingPaymentDetailsDialog({super.key});

  @override
  State<NewBookingPaymentDetailsDialog> createState() =>
      _NewBookingPaymentDetailsDialogState();
}

class _NewBookingPaymentDetailsDialogState
    extends State<NewBookingPaymentDetailsDialog> {
  final NewBookingPaymentDetailsController controller = Get.put(
    NewBookingPaymentDetailsController(),
  );
  ...
  Widget _buildPaymentDetails() {
    return Column(
      ...
      children: [
        ...
        _buildPaymentRow('Installment Amount', '₹${controller.bookingAmount}'),
        // CustomTextField(
