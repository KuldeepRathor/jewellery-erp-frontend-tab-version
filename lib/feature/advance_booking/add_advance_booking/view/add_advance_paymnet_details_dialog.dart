...
import 'package:jewellery_erp_frontend_tab_version/feature/advance_booking/add_advance_booking/view_model/add_advance_paymnet_controller.dart';
...
class AddAdvancePaymentDetailsTableData {
  ...
  AddAdvancePaymentDetailsTableData({
...
class AddAdvancePaymentDetailsDialog extends StatefulWidget {
  const AddAdvancePaymentDetailsDialog({
    super.key,
  ...
  @override
  State<AddAdvancePaymentDetailsDialog> createState() =>
      _AddAdvancePaymentDetailsDialogState();
}

class _AddAdvancePaymentDetailsDialogState
    extends State<AddAdvancePaymentDetailsDialog> {
  late final AddAdvancePaymentDetailsController controller;

  @override
  void initState() {
    super.initState();
    // Initialize the controller with bookingId from widget
    controller = Get.put(
      AddAdvancePaymentDetailsController(bookingId: widget.bookingId),
    );
  ...
  Widget _buildPaymentDetails() {
    controller.installmentAmountController = widget.totalAmount;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const CustomText(
