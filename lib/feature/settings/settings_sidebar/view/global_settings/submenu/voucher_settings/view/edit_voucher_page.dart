...
// import 'package:jewellery_erp_frontend_tab_version/feature/settings/settings_sidebar/view/global_settings/submenu/voucher_settings/view_model/edit_voucher_controller.dart';
...
//   final String typeName; // for display in dropdown
//   final String commodityName; // for display in dropdown
...
//   late final EditVoucherController controller;
//   @override
//   void initState() {
//     super.initState();
//     controller = Get.put(EditVoucherController());
//     controller.loadSequenceForEdit(
//       voucherSeriesType: widget.voucherSeriesType,
//       voucherSeriesCommodity: widget.voucherSeriesCommodity,
...
//     Get.delete<EditVoucherController>();
//     super.dispose();
//   }
...
//           onInvoke: (intent) {
//             final isLoading = controller.isUpdatingVoucher.value;
//             if (!isLoading) controller.updateVoucher();
//             return;
//           },
//         ),
...
//                 child: Obx(
//                   () => Table(
//                     key: ValueKey(controller.rows.length),
