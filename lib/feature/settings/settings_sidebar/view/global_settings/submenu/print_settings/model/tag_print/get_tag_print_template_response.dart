...
class GetTagPrintTemplateResponse {
  bool? leftDesignName;
  bool? leftVendor;
  bool? leftTagNumber;
  ...
  factory GetTagPrintTemplateResponse.fromRawJson(String str) =>
      GetTagPrintTemplateResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetTagPrintTemplateResponse.fromJson(Map<String, dynamic> json) =>
      GetTagPrintTemplateResponse(
