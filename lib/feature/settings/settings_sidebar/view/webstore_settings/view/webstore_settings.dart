...
class WebstoreSettingsPage extends StatefulWidget {
  const WebstoreSettingsPage({super.key});

  @override
  State<WebstoreSettingsPage> createState() => _WebstoreSettingsPageState();
}

class _WebstoreSettingsPageState extends State<WebstoreSettingsPage> {
  late final WebstoreSettingsController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(WebstoreSettingsController(), tag: 'webstoreSettings');
  }

  @override
  void dispose() {
    Get.delete<WebstoreSettingsController>(tag: 'webstoreSettings');
    super.dispose();
  }
  ...
  Widget _buildDraggableSidebar(WebstoreSettingsController controller) {
    return Obx(() {
      return Stack(
        children: [
          // The actual sidebar
  ...
  Widget _buildSidebarItem(
    WebstoreSettingsController controller,
    WebstoreSidebarItem item,
  ) {
    return Obx(() {
