...
class SalesOldGoldDialog extends StatefulWidget {
  const SalesOldGoldDialog({super.key});

  @override
  State<SalesOldGoldDialog> createState() => _SalesOldGoldDialogState();
}

class _SalesOldGoldDialogState extends State<SalesOldGoldDialog> {
  final SalesOldGoldController controller = Get.find<SalesOldGoldController>();
  ...
  Widget _buildCodeDropdown({
    required int index,
    required SalesOldGoldController controller,
