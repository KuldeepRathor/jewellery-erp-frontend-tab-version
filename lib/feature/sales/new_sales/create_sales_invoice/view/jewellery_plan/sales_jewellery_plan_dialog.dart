...
class SalesJewelleryPlanDialog extends StatefulWidget {
  const SalesJewelleryPlanDialog({super.key});

  @override
  State<SalesJewelleryPlanDialog> createState() =>
      _SalesJewelleryPlanDialogState();
}

class _SalesJewelleryPlanDialogState extends State<SalesJewelleryPlanDialog> {
  final SalesJewelleryPlanController controller =
            ...
            Row(
              ...
              children: [
                ...
                CustomInkButton(
                  width: 120,
                  onPressed: () async {
                    await controller.showCustomReusableOtpDialog();
                  },
                  text: "Send OTP",
        ...
        children: [
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                log(
                  "Value json : ${controller.selectedJewelleryPlans.map((element) => element.toJson())}",
                );
