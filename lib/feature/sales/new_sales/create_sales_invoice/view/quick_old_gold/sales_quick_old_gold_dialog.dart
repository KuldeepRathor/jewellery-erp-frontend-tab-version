...
class SalesQuickOldGoldDialog extends StatelessWidget {
  const SalesQuickOldGoldDialog({super.key});

  @override
  Widget build(BuildContext context) {
    final SalesQuickOldGoldController controller =
  ...
  Widget _buildOldGoldForm(SalesQuickOldGoldController controller) {
    return Padding(
  ...
  Widget _buildFooter(SalesQuickOldGoldController controller) {
    return Container(
