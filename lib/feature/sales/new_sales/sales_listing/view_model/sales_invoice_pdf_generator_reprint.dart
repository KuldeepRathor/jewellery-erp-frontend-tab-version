...
class SalesInvoiceReprintPdfGenerator {
  // static const PdfPageFormat customPageFormat = PdfPageFormat(
  //   17.8 * PdfPageFormat.cm, // width: 17.8cm = 504.63 points
  //   21.0 * PdfPageFormat.cm, // height: 21cm = 595.35 points
  //   marginAll: 20, // Reduced margin for smaller page
  // );
          ...
          build: (pw.Context context) {
            ...
            final mainContent = pw.Column(
              ...
              children: [
                ...
                //       _buildPaymentMethodCell(
                //         'Purchase',
                //         _formatZeroAmount(paymentDetails?.purchaseOldGold,
                //             defaultEmpty: ' '),
                //         font,
                //       ),
                //     ],
  ...
  //   final nonCashPayments = paymentDetails
  //       .where((payment) =>
  //           payment.method != null &&
  ...
  //     List<PaymentMethodDetail>? paymentDetails, String method) {
  //   if (paymentDetails == null || paymentDetails.isEmpty) {
  //     return '';
  //   }
  ...
  //     String label, String amount, pw.Font font) {
  //   return pw.Column(
  ...
  static pw.Widget _buildOldGoldTable(
    ...
    return pw.Column(
      ...
      children: [
        pw.Text(
          'OLD GOLD PURCHASE-Bill.${sale.purchaseInvoiceNumber ?? ""}',
        ...
        pw.Table(
          ...
          children: [
            ...
            ...sale.oldGolds!.map((oldGold) {
              ...
              // Get purity type
              final purity = "${oldGold.purityType}%";
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          // if (showRoundOff)
          //   _buildRightAlignedAmountRow(
          //       'Round Off:', payment.roundOff ?? '0', font),
          // if (!showOldGold)
          //   _buildRightAlignedAmountRow(
          //       'Received:', payment.receivedAmount ?? '0', font),
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          // if (showBalance)
          //   _buildRightAlignedAmountRow(
          //       'Balance:', payment.balanceAmount ?? '0', font),
        ],
      ),
    );
  }
