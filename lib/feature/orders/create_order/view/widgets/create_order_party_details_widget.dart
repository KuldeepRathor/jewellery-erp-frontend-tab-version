...
// class CreateOrderPartyDetailsWidget extends StatelessWidget {
//   CreateOrderPartyDetailsWidget(
//       {super.key,
...
//                   // Expanded(
//                   //   flex: 1,
//                   //   child: Obx(() => CustomButton1(
//                   //         buttonName: newDeliveryController.isVerified.value
//                   //             ? "Verified"
//                   //             : "Verify",
//                   //         onTap: () {
//                   //           if (controller
...
//                               .name ??
//                           'N/A',
//               sgst: controller.selectedParty.value is CustomerSearchValue
//                   ? (controller.selectedParty.value as CustomerSearchValue)
//                           .gstNumber ??
//                       'N/A'
//                   : (controller.selectedParty.value as VendorSearchValue)
//                           .gstNumber ??
//                       'N/A',
//               address: controller.selectedParty.value is CustomerSearchValue
//                   ? (controller.selectedParty.value as CustomerSearchValue)
//                           .address
//                           ?.firstOrNull
//                           ?.addressLine1 ??
...
//               value: null, label: 'Invalid Entry');
//         }
