...
class PurchaseReturnExpandablePaymentDetailsWidget extends StatefulWidget {
  final PurchaseReturnResponsePaymentDetail paymentDetail;

  const PurchaseReturnExpandablePaymentDetailsWidget({
    super.key,
    required this.paymentDetail,
  });

  @override
  PurchaseReturnExpandablePaymentDetailsWidgetState createState() =>
      PurchaseReturnExpandablePaymentDetailsWidgetState();
}

class PurchaseReturnExpandablePaymentDetailsWidgetState
    extends State<PurchaseReturnExpandablePaymentDetailsWidget> {
  ...
  String calculateTcsTdsTotal(PurchaseReturnResponsePaymentDetail detail) {
