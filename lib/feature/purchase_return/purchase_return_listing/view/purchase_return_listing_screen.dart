...
import 'package:jewellery_erp_frontend_tab_version/feature/purchase_return/purchase_return_listing/view_model/customer_purchase_return_invoice_listing_viewmodel.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/purchase_return/purchase_return_listing/view_model/vendor_purchase_return_invoice_listing_viewmodel.dart';
...
class PurchaseReturnInvoiceListingPage extends StatefulWidget {
  ...
  @override
  State<PurchaseReturnInvoiceListingPage> createState() =>
      _PurchaseReturnInvoiceListingPageState();
}

class _PurchaseReturnInvoiceListingPageState
    extends State<PurchaseReturnInvoiceListingPage>
    with SingleTickerProviderStateMixin {
  final customerController = Get.put(
    CustomerPurchaseReturnInvoiceListingViewModel(),
  );
  final vendorController = Get.put(
    VendorPurchaseReturnInvoiceListingViewModel(),
  );

  final SidebarController sidebarController = Get.find<SidebarController>();
  final ScrollController _scrollController = ScrollController();
  late TabController _tabController;
  final String _headerText = 'Purchase Return Register';
  @override
  void initState() {
    super.initState();
  ...
  void _handleTabSelection() {
    // Only execute when tab change is complete
      ...
      child: Material(
        ...
        child: Ink(
          ...
          child: TabBar(
            ...
            isScrollable: true,
            tabs: const [
              Tab(text: 'Vendor Purchase Returns'),
              Tab(text: 'Customer Purchase Returns'),
            ],
  ...
  Widget _buildCustomerTable(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: GetBuilder<CustomerPurchaseReturnInvoiceListingViewModel>(
          builder:
  ...
  Widget _buildVendorTable(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: GetBuilder<VendorPurchaseReturnInvoiceListingViewModel>(
          builder:
  ...
  Widget _buildCustomerTableStates(
    CustomerPurchaseReturnInvoiceListingViewModel controller,
  ) {
  ...
  Widget _buildVendorTableStates(
    VendorPurchaseReturnInvoiceListingViewModel controller,
  ) {
