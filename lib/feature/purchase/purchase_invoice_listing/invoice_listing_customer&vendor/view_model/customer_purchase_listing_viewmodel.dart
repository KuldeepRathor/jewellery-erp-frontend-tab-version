...
// class CustomerPurchaseListingViewModel extends GetxController {
...
//       final response =
//           await _aggregateRepository.getPurchaseInvoiceById(id: id);
...
//       bool isSearch = false,
//       PurchaseInvoiceListingRequest? requestBody}) async {
//     if (resetList) {
...
//     } else {
//       log("Conditions not met - isLoadingMore: ${isLoadingMore.value}, hasMorePages: ${hasMorePages.value}");
//     }
//   }
