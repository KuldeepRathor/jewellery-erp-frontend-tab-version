...
class OtherServicePurchaseListingViewmodel extends GetxController {
  ...
  List<String> popUpValues = ["Return", "Cancel"];
          ...
          child: CustomPopupMenuButtonWidget<String>(
            ...
            onSelected: (String value) {
              ...
              switch (value) {
                ...
                case 'Cancel':
                  // Handle Cancel
                  PermissionGuardUtil.withActionPermission(6155, () {
                    Get.dialog(
                      CancelPaymentDialog(
                        subtitle:
  ...
  //   try {
  //     final pdfBytes =
  //         await PurchaseInvoicePdfGenerator.generateInvoice(invoice);
  ...
  Future<void> getCustomerPurchaseInvoice({
    ...
    try {
      final otherServicePurchaseController =
      ...
      final response = await _purchaseInvoiceRepository.getPurchaseInvoiceTwo(
        ...
        partyType: null,
        isService: true,
        requestBody: otherServicePurchaseController,
      );
