...
class ServicePartyDetailsWidget extends StatelessWidget {
  ServicePartyDetailsWidget({
    super.key,
  ...
  final ServicePartyDetailsController controller =
...
class SearchDropdownMenu extends StatelessWidget {
  ...
  Future<void> _onItemSelected(dynamic item, bool isPurchase) async {
    if (item is CustomerSearchValue || item is VendorSearchValue) {
      ...
      final ServiceVendorBillDetailsWidgetController
