...
class _ServiceItemDetailsWidgetState extends State<ServiceItemDetailsWidget> {
  final ServiceItemDetailsWidgetController controller = Get.put(
  ...
  TableRow _buildTableHeaders(ServiceItemDetailsWidgetController controller) {
    List<Widget> cells = [];
  ...
  List<TableRow> _buildRows(ServiceItemDetailsWidgetController controller) {
  ...
  TableRow _buildTableRow(
    int index,
    ServiceItemDetailsWidgetController controller,
  ) {
    List<Widget> cells = [
      _buildCell(
      ...
      Obx(
        () => _buildCell(
          textController: TextEditingController(
            text: controller.controllers[index].hsn_sac,
          ),
  ...
  Widget _buildCell({
    ...
    bool editable = true,
    int rowIndex = 0,
    required ServiceItemDetailsWidgetController controller,
    FocusNode? focusNode,
    bool readOnly = false,
  }) {
    return Container(
  ...
  //     int rowIndex, ServiceItemDetailsWidgetController controller) {
  //   return Theme(
  //     data: ThemeData(
