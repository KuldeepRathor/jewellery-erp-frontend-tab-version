...
class VendorBillDetailsWidget extends StatefulWidget {
  const VendorBillDetailsWidget({super.key, this.focusNode});
  final FocusNode? focusNode;

  @override
  State<VendorBillDetailsWidget> createState() =>
      _VendorBillDetailsWidgetState();
}

class _VendorBillDetailsWidgetState extends State<VendorBillDetailsWidget> {
  final VendorBillDetailsController controller =
