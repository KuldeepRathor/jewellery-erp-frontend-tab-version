...
class CustomerPaymentDetailsController extends GetxController {
  ...
  Future<void> fetchDebitNotes() async {
    try {
      ...
      CustomerDetailsController partyController =
  ...
  Future<void> getRoundOffTotal() async {
    ...
    String igstVal = await _organizationRepository.getGstType(
      gstNumber:
          Get.find<CustomerDetailsController>().selectedParty.value.gstNumber
              .toString(),
    );
