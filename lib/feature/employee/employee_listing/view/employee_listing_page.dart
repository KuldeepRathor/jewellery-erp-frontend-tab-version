...
import 'package:jewellery_erp_frontend_tab_version/feature/employee/add_employee/view/add_employee_dialog.dart';
...
class EmployeeListingPage extends StatefulWidget {
  const EmployeeListingPage({super.key});
...
class _EmployeeListingPageState extends State<EmployeeListingPage> {
  final controller = Get.put<EmployeeListingController>(
  ...
  void initState() {
    ...
    controller.getEmployeeListingDetails(resetList: true);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ActionScopeWidget(
        ...
        //   );
        // },
        additionalShortcuts: <LogicalKeySet, Intent>{
          LogicalKeySet(LogicalKeyboardKey.control, LogicalKeyboardKey.keyA):
              const ActivateIntent(),
        },
        additionalActions: <Type, Action<Intent>>{
  ...
  Widget _buildVendorTable(EmployeeListingController controller) {
    return Expanded(
      child: Container(
          ...
          children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: Obx(() {
                  final apiStatus =
                      controller.getEmployeeListingResponse.value.status;

                  if (apiStatus == Status.COMPLETED) {
                    final data =
                        controller.getEmployeeListingResponse.value.data;
                                ...
                                children: List.generate(
                                  ...
                                  (cellIndex) {
                                    ...
                                    switch (cellIndex) {
                                      ...
                                      case 2:
                                        cellContent =
                                            "${headerValue?.firstName} ${headerValue?.lastName}";
                                        break;
                                      case 3:
                                        cellContent = headerValue?.email ?? "-";
                                        break;
                                      case 4:
                                        cellContent =
