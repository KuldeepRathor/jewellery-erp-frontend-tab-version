...
class GetAllStockHeadsResponse {
  List<GetAllStockHeadsValue>? values;

  GetAllStockHeadsResponse({
    this.values,
  });

  factory GetAllStockHeadsResponse.fromRawJson(String str) =>
      GetAllStockHeadsResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllStockHeadsResponse.fromJson(Map<String, dynamic> json) =>
      GetAllStockHeadsResponse(
        values: json["values"] == null
            ? []
            : List<GetAllStockHeadsValue>.from(
                json["values"]!.map((x) => GetAllStockHeadsValue.fromJson(x))),
      );
...
class GetAllStockHeadsValue {
  ...
  factory GetAllStockHeadsValue.fromRawJson(String str) =>
      GetAllStockHeadsValue.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllStockHeadsValue.fromJson(Map<String, dynamic> json) =>
      GetAllStockHeadsValue(
        id: json["id"],
        name: json["name"],
        code: json["code"],
