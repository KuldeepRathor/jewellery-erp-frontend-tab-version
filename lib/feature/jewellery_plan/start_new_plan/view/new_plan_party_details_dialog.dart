...
class NewPlanPartyDetailsWidget extends StatelessWidget {
  NewPlanPartyDetailsWidget({
    super.key,
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Obx(
                      () => CustomButton1(
                        buttonName:
                            planController.isVerified.value
                                ? "Verified"
                                : "Verify",
                        onTap: () {
                          if (controller.selectedParty.value != null &&
                            ...
                            if (customerPhone != null &&
                              ...
                              planController.setSearchQuery(customerPhone);
                            } else {
                              showErrorToast(
                                message: "Selected Customer has no phone no",
                              );
                            }
                          } else {
                            showErrorToast(message: "Select a customer first");
                          }
                        },
                      ),
                    ),
