...
// import 'package:jewellery_erp_frontend_tab_version/feature/customer_ledger/add_installment/model/add_installment_request.dart';
// import 'package:jewellery_erp_frontend_tab_version/feature/customer_ledger/add_installment/view_model/add_installment_view_model.dart';
// import 'package:jewellery_erp_frontend_tab_version/feature/customer_ledger/customer_ledger_listing/model/get_jewellery_plan_response_model.dart';
// import 'package:jewellery_erp_frontend_tab_version/feature/home/view/components/dialog_box/payment_details_dialog.dart';
// import 'package:jewellery_erp_frontend_tab_version/feature/purchase/view_model/bill_details_widget_controller.dart';
// import 'package:jewellery_erp_frontend_tab_version/feature/purchase/view_model/item_details_widget_controller.dart';
// import 'package:jewellery_erp_frontend_tab_version/feature/purchase/view_model/party_details_controller.dart';
...
// class CancelPlanPaymentDetailsController extends GetxController {
...
//           installmentAmountController.text = planData!.cost!;
//           update();
//         }
//       }
//     });
...
//   void addRow() {
//     log("Adding row");
//     controllers.add(PaymentDetailsTableData(
//       amount: TextEditingController(),
//       method: TextEditingController(
//         text: methodList.first,
//       ),
...
//     log("moving focus movePreviousFocus to $currentRowIndex : $currentColIndex");
//   }

//   void moveNextFocus() {
//     log("The values are ${controllers[currentRowIndex.value].tableFocusNodes.length} $currentColIndex");
//     if (currentColIndex <
//         controllers[currentRowIndex.value].tableFocusNodes.length - 1) {
//       currentColIndex.value++;
...
//   KeyEventResult moveFocus(KeyEventResult result, LogicalKeyboardKey keyboard,
...
//       final paymentOptions = controllers.map((payment) {
//         DateTime? parsedDate;
//         try {
...
//       try {
//         installmentDate = DateFormat('dd-MM-yyyy')
//             .parse(viewModel.installmentDateController.text);
//         log("Parsed installment date successfully: ${viewModel.installmentDateController.text}");
//       } catch (e) {
...
//           date: installmentDate, // This is already checked for null above
//           amount: targetAmount.toString(),
//           customerName:
//               planData.customerName, // removed ?? "" since field is nullable
//           phone: planData.phone, // removed ?? "" since field is nullable
