...
class AddInstallmentPaymentDetailsTableData {
  ...
  AddInstallmentPaymentDetailsTableData({
...
class AddInstallmentPaymentDetailsDialog extends StatefulWidget {
  const AddInstallmentPaymentDetailsDialog({super.key});

  @override
  State<AddInstallmentPaymentDetailsDialog> createState() =>
      _AddInstallmentPaymentDetailsDialogState();
}

class _AddInstallmentPaymentDetailsDialogState
    extends State<AddInstallmentPaymentDetailsDialog> {
  final AddInstallmentPaymentDetailsController controller = Get.put(
    AddInstallmentPaymentDetailsController(),
  );
