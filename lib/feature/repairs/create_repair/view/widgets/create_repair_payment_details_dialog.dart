...
import 'package:jewellery_erp_frontend_tab_version/feature/repairs/create_repair/view_model/create_repair_payments_detail_controller.dart';
...
class CreateRepairPaymentDetailsTableData {
  ...
  CreateRepairPaymentDetailsTableData({
...
class CreateRepairPaymentDetailsDialog extends StatefulWidget {
  const CreateRepairPaymentDetailsDialog({super.key});

  @override
  State<CreateRepairPaymentDetailsDialog> createState() =>
      _CreateRepairPaymentDetailsDialogState();
}

class _CreateRepairPaymentDetailsDialogState
    extends State<CreateRepairPaymentDetailsDialog> {
  final CreateRepairPaymentDetailsController controller = Get.put(
    CreateRepairPaymentDetailsController(),
  );

  final CreateRepairItemDetailsController itemDetailsController =
        ...
        actions: <Type, Action<Intent>>{
          ...
          SaveStoneDetailsIntent: CallbackAction<SaveStoneDetailsIntent>(
            onInvoke: (intent) async {
              ...
              await controller.validateAndSaveRepair();
              return;
            },
          ),
        },
  ...
  Widget _buildPaymentDetails() {
    return Column(
      ...
      children: [
        ...
        // Obx(
        //   () => _buildPaymentRow(
        //       'Total', '₹ ${controller.roundOffTotalToShow.value}'),
        // ),
      ...
      child: Row(
        ...
        children: [
          Material(
            ...
            child: InkWell(
              onTap: () => controller.validateAndSaveRepair(),
