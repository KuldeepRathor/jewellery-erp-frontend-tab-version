...
class GetAllPurityTypesSegregatedResponse {
  String? id;
  ...
  GetAllPurityTypesSegregatedResponse({
    this.id,
    this.organizationId,
    this.gold,
    this.silver,
  ...
  factory GetAllPurityTypesSegregatedResponse.fromRawJson(String str) =>
      GetAllPurityTypesSegregatedResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllPurityTypesSegregatedResponse.fromJson(
