...
class RepairStatusDialog extends StatelessWidget {
  ...
  Widget _buildStatusDropdown({required RepairStatusController controller}) {
  ...
  Widget build(BuildContext context) {
    final RepairStatusController controller = Get.put(
