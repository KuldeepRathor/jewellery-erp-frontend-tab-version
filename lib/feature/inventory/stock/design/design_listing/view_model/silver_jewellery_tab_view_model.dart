...
class SilverJewelleryTabViewModel extends GetxController {
  ...
  final silver_jewellery_headers =
      [
        "Sr",
        "Code",
        "Design Name",
  ...
  final silver_jewellery_column_widths =
      [
        0.1,
        0.3 + 0.111,
        0.825 + 0.111,
  ...
  void onInit() {
    ...
    getSilverJewellery(resetList: true);
  }
  ...
  void onInvoiceNoTapped(String? id) {
    if (id != null) {
      ...
      sidebarController.navigateToWidget(
        newChild: DesignView(id: id, designType: "Silver"),
      );
    }
  }
  ...
  TableRow buildCustomerInvoiceTableHeaders() {
    ...
    for (int i = 0; i < silver_jewellery_headers.length; i++) {
      String customer_header = silver_jewellery_headers.elementAt(i);
      customer_cells.add(
        Row(
          children: [
            ...
            Flexible(
              child: CustomText(
                text: silver_jewellery_headers.elementAt(i),
                color: Colors.white,
                fontSize: 14,
                overflow: TextOverflow.ellipsis,
    ...
    if (customerInvoice == null) {
      return TableRow(
        children: List.generate(
          silver_jewellery_headers.length,
          (index) => Container(),
        ),
      );
    }

    for (int i = 0; i < silver_jewellery_headers.length - 1; i++) {
      Widget cellWidget;
      switch (i) {
  ...
  Future<void> getSilverJewellery({
  ...
  Future<void> silverLoadMoreItems() async {
  ...
  void setSearchQuery(String query) {
    ...
    _debouncer.run(() async {
      await getSilverJewellery(resetList: true, isSearch: true);
    });
  }
