...
class ImageCropDialog extends StatefulWidget {
  ...
  const ImageCropDialog({
    ...
    this.useCircleUi = false, // Default to circular UI
  });
...
class _ImageCropDialogState extends State<ImageCropDialog> {
  ...
  Widget build(BuildContext context) {
    String titleText =
        widget.useCircleUi
            ? 'Crop Profile Photo'
            : 'Crop Image (${widget.aspectRatio}:1)';
                        ...
                        return Stack(
                          children: [
                            Crop(
                              ...
                              withCircleUi:
                                  widget
                                      .useCircleUi, // Use circle UI if requested
                              fixCropRect: true,
                              radius: 8,
                              interactive: true,
                              initialRectBuilder:
                              ...
                              aspectRatio:
                                  widget
                                      .aspectRatio, // Use provided aspect ratio
                            ),
                            if (_isCropping)
                              Container(
