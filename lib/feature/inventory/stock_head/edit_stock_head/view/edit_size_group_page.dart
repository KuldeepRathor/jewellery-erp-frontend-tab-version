...
class EditSizeGroupTable extends StatelessWidget {
  EditSizeGroupTable({super.key});

  final EditSizeGroupController controller = Get.put(EditSizeGroupController());
  ...
  TableRow _buildTableRow(int index, EditSizeGroupController controller) {
    return TableRow(
      children: [
        _buildCell(
  ...
  Widget _buildCell({
    ...
    required EditSizeGroupController controller,
    required FocusNode focusNode,
  }) {
    if (colIndex == 0) {
      // Code column
