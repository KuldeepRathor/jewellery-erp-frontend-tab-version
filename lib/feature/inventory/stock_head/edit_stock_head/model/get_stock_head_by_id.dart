...
class GetStockHeadById {
  ...
  factory GetStockHeadById.fromRawJson(String str) =>
      GetStockHeadById.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetStockHeadById.fromJson(Map<String, dynamic> json) =>
      GetStockHeadById(
        id: json["id"],
        name: json["name"],
        code: json["code"],
