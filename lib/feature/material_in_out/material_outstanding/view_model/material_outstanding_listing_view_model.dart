...
class MaterialOutstandingListingViewModel extends GetxController {
  ...
  final columnWidths = [0.1, 1.0, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.1].obs;
  final _debouncer = CustomDebouncer(milliseconds: 500);

  final customerListingResponse =
      Rx<ApiResponse<GetMaterialOutstandingListingResponse>>(
    ...
    for (int i = 0; i < headers.length - 1; i++) {
      ...
      switch (i) {
        case 0:
          ...
          break;
        case 1:
          cellContent = customerDetail?.partyName ?? "-";
          break;
        case 2:
          cellContent = customerDetail?.weightDebit ?? "-";
          break;
        case 3:
          cellContent = customerDetail?.weightCredit ?? "-";
          break;
        case 4:
          cellContent = "₹ ${customerDetail?.amountDebit ?? "-"}";
          break;
        case 5:
          cellContent = customerDetail?.closingWeight ?? "-";
          break;
        case 6:
          cellContent = "₹ ${customerDetail?.amountCredit ?? "-"}";
          break;
        case 7:
          cellContent = "₹ ${customerDetail?.closingAmount ?? "-"}";
          break;
      }
      cells.add(
        Column(
  ...
  Future<void> getCustomerListingDetails({
    ...
    try {
      final response = await _inventoryRepository.getMaterialOutstandingListing(
      ...
      if (resetList) {
        ...
        List<GetMaterialOutstandingListingValue> newData = [
          ...currentData,
          ...response.values ?? [],
        ];
