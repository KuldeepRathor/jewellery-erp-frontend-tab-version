...
import 'package:jewellery_erp_frontend_tab_version/feature/material_in_out/material_outstanding/view_model/material_outstanding_listing_view_model.dart';
...
class MaterialOutstandingListing extends StatefulWidget {
  const MaterialOutstandingListing({super.key});

  @override
  State<MaterialOutstandingListing> createState() =>
      _MaterialOutstandingListingState();
}

class _MaterialOutstandingListingState
    extends State<MaterialOutstandingListing> {
  // final controller =
  //     Get.put<CustomerListingViewmodel>(CustomerListingViewmodel());
  final MaterialOutstandingListingViewModel controller = Get.put(
    MaterialOutstandingListingViewModel(),
  );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ActionScopeWidget(
        onNewButtonTap: onNewMaterialOutstandingTap,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            HeaderWidget(
              header: 'Material Outstanding',
              wantBackButton: true,
              onBackButtonTap: () {
                Get.back();
              },
  ...
  Widget _buildActionBar() {
    return Row(
      children: [
        ...
        const Spacer(),
        // CustomButton2(
        //   onTap: onNewMaterialOutstandingTap,
  ...
  void onNewMaterialOutstandingTap() {}
  ...
  Widget _buildCustomerTable(MaterialOutstandingListingViewModel controller) {
    return Expanded(
      child: Container(
