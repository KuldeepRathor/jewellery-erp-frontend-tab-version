...
class MaterialOutRequestModel {
  ...
  factory MaterialOutRequestModel.fromRawJson(String str) =>
      MaterialOutRequestModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory MaterialOutRequestModel.fromJson(Map<String, dynamic> json) =>
      MaterialOutRequestModel(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "remark": remark,
        "invoice_create_date": invoiceCreateDate == null
            ? null
        ...
        "invoice_receive_date": invoiceReceiveDate == null
            ? null
