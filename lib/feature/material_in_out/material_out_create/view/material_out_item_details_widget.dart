...
class MaterialOutItemDetailsWidget extends StatefulWidget {
  const MaterialOutItemDetailsWidget({super.key});

  @override
  State<MaterialOutItemDetailsWidget> createState() =>
      _MaterialOutItemDetailsWidgetState();
}

class _MaterialOutItemDetailsWidgetState
    extends State<MaterialOutItemDetailsWidget> {
  ...
  TableRow _buildTableHeaders(ItemDetailsController controller) {
    List<Widget> cells = [];
  ...
  List<TableRow> _buildRows(ItemDetailsController controller) {
  ...
  TableRow _buildTableRow(int index, ItemDetailsController controller) {
    List<Widget> cells = [
      _buildCell(
  ...
  Widget _buildCell({
    ...
    bool editable = true,
    int rowIndex = 0,
    required ItemDetailsController controller,
    FocusNode? focusNode,
  }) {
    return Container(
      child:
  ...
  Widget _buildMoreOptionsCell(int rowIndex, ItemDetailsController controller) {
    return Theme(
      data: ThemeData(
