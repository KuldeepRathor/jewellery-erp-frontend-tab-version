...
import 'package:jewellery_erp_frontend_tab_version/feature/material_in_out/material_out_listing/view_model/material_out_listing_view_model.dart';
...
class MaterialOutListing extends StatefulWidget {
  final bool? wantBackButton;
  const MaterialOutListing({super.key, this.wantBackButton = false});

  @override
  State<MaterialOutListing> createState() => _MaterialOutListingState();
}

class _MaterialOutListingState extends State<MaterialOutListing> {
  final MaterialOutListingViewModel controller = Get.put(
    MaterialOutListingViewModel(),
  );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ActionScopeWidget(
        onNewButtonTap: onNewMaterialOutTap,
        child: Column(
  ...
  void onNewMaterialOutTap() {
    SidebarController sidebarController = Get.find();
    sidebarController.navigateToWidget(newChild: const MaterialOutPage());
  }
  ...
  Widget _buildCustomerTable(MaterialOutListingViewModel controller) {
    return Expanded(
      child: Container(
