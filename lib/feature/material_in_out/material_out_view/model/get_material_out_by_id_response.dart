...
class GetMaterialOutByIdResponse {
  String? id;
  ...
  factory GetMaterialOutByIdResponse.fromRawJson(String str) =>
      GetMaterialOutByIdResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetMaterialOutByIdResponse.fromJson(Map<String, dynamic> json) =>
      GetMaterialOutByIdResponse(
        id: json["id"],
