...
class MaterailInVendorBillDetailsController extends GetxController {
  ...
  final InventoryRepository _invoiceRepository = InventoryRepository();
  ...
  Future<void> loadSequencesDropdown({
    ...
    try {
      ...
      final response = await _invoiceRepository.getSequencesDropdown(
