...
class MaterialInItemDetailsWidget extends StatefulWidget {
  const MaterialInItemDetailsWidget({super.key});

  @override
  State<MaterialInItemDetailsWidget> createState() =>
      _MaterialInItemDetailsWidgetState();
}

class _MaterialInItemDetailsWidgetState
    extends State<MaterialInItemDetailsWidget> {
