...
import 'package:jewellery_erp_frontend_tab_version/feature/material_in_out/material_in_create/view/material_in_item_details_widget.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/material_in_out/material_in_create/view/material_in_party_details_widget.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/material_in_out/material_in_create/view/material_in_vendor_bill_details_widget.dart';
...
import 'package:jewellery_erp_frontend_tab_version/feature/material_in_out/material_in_create/view_model/material_in_view_model.dart';
...
class MaterialInPage extends StatefulWidget {
  const MaterialInPage({super.key});
...
class MaterialInPageState extends State<MaterialInPage> {
  ...
  final MaterailInVendorBillDetailsController vendorBillDetailsController =
      Get.put<MaterailInVendorBillDetailsController>(
        MaterailInVendorBillDetailsController(),
      );
  final MaterialInViewModel purchaseReturnViewModel =
      Get.put<MaterialInViewModel>(MaterialInViewModel());
        ...
        MoveToNextScreenIntent: CallbackAction<MoveToNextScreenIntent>(
          onInvoke: (intent) async {
            ...
            if (itemsValue == true && billValue == true) {
              purchaseReturnViewModel.validateAndPostMaterialIn();
            } else {
                            ...
                            children: [
                              Row(
                                children: [
                                  Expanded(
                                    flex: 3,
                                    child: MaterialInPartyDetailsWidget(
                                      isPurchase: false,
                                  ...
                                  const Expanded(
                                    flex: 2,
                                    child: MaterialInVendorBillDetailsWidget(),
                                  ),
                                ],
                              ),
                              const SizedBox(height: 16),
                              const MaterialInItemDetailsWidget(),
