...
class GetEstimationByEstimateResponse {
  String? id;
  dynamic customerId;
  dynamic partyType;
  ...
  String? remarks;
  List<GetEstimationByEstimateResponseLineItem>? lineItems;
  ...
  GetEstimationByEstimateResponse({
    this.id,
    this.customerId,
    this.partyType,
    this.partyDetails,
  ...
  factory GetEstimationByEstimateResponse.fromRawJson(String str) =>
      GetEstimationByEstimateResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetEstimationByEstimateResponse.fromJson(Map<String, dynamic> json) =>
      GetEstimationByEstimateResponse(
        id: json["id"],
        ...
        lineItems: json["line_items"] == null
            ? []
            : List<GetEstimationByEstimateResponseLineItem>.from(
                json["line_items"]!.map((x) =>
                    GetEstimationByEstimateResponseLineItem.fromJson(x))),
...
class GetEstimationByEstimateResponseLineItem {
  String? id;
  ...
  String? salesAmount;
  String? totalAmount;
  dynamic makingChargesAmount;
  TaggingDetails? taggingDetails;
  dynamic salesPerson;

  GetEstimationByEstimateResponseLineItem({
    this.id,
  ...
  factory GetEstimationByEstimateResponseLineItem.fromRawJson(String str) =>
      GetEstimationByEstimateResponseLineItem.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetEstimationByEstimateResponseLineItem.fromJson(
