...
class AddOrdersDialog extends StatefulWidget {
  const AddOrdersDialog({super.key});

  @override
  State<AddOrdersDialog> createState() => _AddOrdersDialogState();
}

class _AddOrdersDialogState extends State<AddOrdersDialog> {
  final AddOrdersDialogController controller =
