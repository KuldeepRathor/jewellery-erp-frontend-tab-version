...
import '../../view_model/estimation_item_details_controller.dart';
...
class EstimationPaymentDetailsDialog extends StatefulWidget {
  const EstimationPaymentDetailsDialog({super.key});

  @override
  State<EstimationPaymentDetailsDialog> createState() =>
      _EstimationPaymentDetailsDialogState();
}

class _EstimationPaymentDetailsDialogState
    extends State<EstimationPaymentDetailsDialog> {
  final EstimationPaymentDetailsController controller =
  ...
  final EstimationViewModel purchaseInvoiceViewmodel =
        ...
        actions: <Type, Action<Intent>>{
          ...
          SaveStoneDetailsIntent: CallbackAction<SaveStoneDetailsIntent>(
            onInvoke: (intent) async {
              ...
              await controller.validateAndPostPurchaseInvoice(isHeld: false);
              return;
            },
          ),
          SaveSalesWithOGHeld: CallbackAction<SaveSalesWithOGHeld>(
            onInvoke: (intent) async {
              // Implement save functionality here
              await controller.validateAndPostPurchaseInvoice(isHeld: true);
              return;
            },
          ),
        },
      ...
      children: [
        ...
        Expanded(
          ...
          child: Focus(
            ...
            //   child: Text("You don't have permission to add payment details"),
            // ),
            child: Form(
    ...
    return Column(
      ...
      children: [
        ...
        Obx(
          () => _buildPaymentRow(
            'Additional Less',
            '₹ ${controller.additional_less.value.toStringAsFixed(2)}',
          ),
        ),
        Obx(
          () => _buildPaymentRow(
          ...
          SizedBox(
            ...
            child: Focus(
              onFocusChange: (hasFocus) {
                // Auto-select all text when field gets focus from any source
                if (hasFocus && textController.text.isNotEmpty) {
                  // Use a small delay to ensure selection happens after focus
        ...
        children: [
          Material(
            ...
            child: InkWell(
              onTap:
                  () =>
                      controller.validateAndPostPurchaseInvoice(isHeld: false),
