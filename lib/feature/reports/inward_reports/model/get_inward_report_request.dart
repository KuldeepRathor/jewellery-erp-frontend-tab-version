...
class GetInwardReportRequest {
  ...
  factory GetInwardReportRequest.fromRawJson(String str) =>
      GetInwardReportRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetInwardReportRequest.fromJson(Map<String, dynamic> json) =>
      GetInwardReportRequest(
        type: json["type"],
