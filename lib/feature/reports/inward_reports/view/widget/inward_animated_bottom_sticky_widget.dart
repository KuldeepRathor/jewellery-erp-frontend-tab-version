...
class InwardAnimatedReportDetailsBottomWidget extends StatefulWidget {
  final bool isVisible;
  final VoidCallback onClose;

  const InwardAnimatedReportDetailsBottomWidget({
    super.key,
  ...
  @override
  State<InwardAnimatedReportDetailsBottomWidget> createState() =>
      _InwardAnimatedReportDetailsBottomWidgetState();
}

class _InwardAnimatedReportDetailsBottomWidgetState
    extends State<InwardAnimatedReportDetailsBottomWidget> {
  ...
  Widget _buildInwardDetails(
    GetTaggingLineItemResponse taggingData,
    GetInwardReportDetailsResponseValue? selectedItem,
