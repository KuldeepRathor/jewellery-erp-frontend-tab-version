...
class WeightGroupDetailsPage extends StatefulWidget {
  final tag_report.GetTaggingItemReportValue stockHead;
  final tag_report.WeightGroup weightGroup;
  final WeightGroupDetailResponse detailsData;

  const WeightGroupDetailsPage({
    super.key,
  ...
  @override
  State<WeightGroupDetailsPage> createState() => _WeightGroupDetailsPageState();
}

class _WeightGroupDetailsPageState extends State<WeightGroupDetailsPage> {
    ...
    return Row(
      children: [
        ...
        CustomButton2(
          ...
          onTap: () {
            final weightGroupId = widget.weightGroup.weightGroupId;
            if (weightGroupId != null) {
              controller.downloadDetailTaggedItemReport(
                weightGroupIds: [weightGroupId],
              );
            } else {
              showErrorToast(message: "Weight group ID not found");
            }
          },
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Weight Group: ${widget.weightGroup.weight}",
                      style: const TextStyle(
                        color: secondaryColor,
                        fontSize: 14,
                        fontWeight: FontWeight.w600,
