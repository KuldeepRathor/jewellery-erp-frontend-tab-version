...
class StoneDetailsDialogForReport extends StatelessWidget {
  final List<GetTaggingItemReportStoneData>? stoneData;

  const StoneDetailsDialogForReport({super.key, required this.stoneData});
