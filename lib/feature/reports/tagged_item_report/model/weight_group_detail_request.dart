...
class WeightGroupDetailRequest {
  ...
  factory WeightGroupDetailRequest.fromRawJson(String str) =>
      WeightGroupDetailRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WeightGroupDetailRequest.fromJson(Map<String, dynamic> json) =>
      WeightGroupDetailRequest(
