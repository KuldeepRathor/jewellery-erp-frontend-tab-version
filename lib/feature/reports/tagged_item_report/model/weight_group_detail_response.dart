...
class WeightGroupDetailResponse {
  List<WeightGroupDetailValue>? values;
  WeightGroupDetailTotal? total;
  List<WeightGroupDetailStoneData>? stoneData;
  WeightGroupDetailStoneTotal? stoneTotal;

  WeightGroupDetailResponse({
    this.values,
    this.total,
    this.stoneData,
    this.stoneTotal,
  ...
  factory WeightGroupDetailResponse.fromRawJson(String str) =>
      WeightGroupDetailResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WeightGroupDetailResponse.fromJson(Map<String, dynamic> json) =>
      WeightGroupDetailResponse(
        values: json["values"] == null
            ? []
            : List<WeightGroupDetailValue>.from(
                json["values"]!.map((x) => WeightGroupDetailValue.fromJson(x))),
        total: json["total"] == null
            ? null
            : WeightGroupDetailTotal.fromJson(json["total"]),
        stoneData: json["stone_data"] == null
            ? []
            : List<WeightGroupDetailStoneData>.from(json["stone_data"]!
                .map((x) => WeightGroupDetailStoneData.fromJson(x))),
        stoneTotal: json["stone_total"] == null
            ? null
            : WeightGroupDetailStoneTotal.fromJson(json["stone_total"]),
      );
...
class WeightGroupDetailStoneData {
  String? stoneId;
  String? stoneName;
  String? pieces;
  String? weight;
  ...
  factory WeightGroupDetailStoneData.fromRawJson(String str) =>
      WeightGroupDetailStoneData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WeightGroupDetailStoneData.fromJson(Map<String, dynamic> json) =>
      WeightGroupDetailStoneData(
...
class WeightGroupDetailStoneTotal {
  String? pieces;
  String? weight;
  String? carat;
  String? totalAmount;

  WeightGroupDetailStoneTotal({
    this.pieces,
    this.weight,
    this.carat,
    this.totalAmount,
  ...
  factory WeightGroupDetailStoneTotal.fromRawJson(String str) =>
      WeightGroupDetailStoneTotal.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WeightGroupDetailStoneTotal.fromJson(Map<String, dynamic> json) =>
      WeightGroupDetailStoneTotal(
        pieces: json["pieces"],
        weight: json["weight"],
        carat: json["carat"],
...
class WeightGroupDetailTotal {
  ...
  factory WeightGroupDetailTotal.fromRawJson(String str) =>
      WeightGroupDetailTotal.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WeightGroupDetailTotal.fromJson(Map<String, dynamic> json) =>
      WeightGroupDetailTotal(
...
class WeightGroupDetailValue {
  ...
  factory WeightGroupDetailValue.fromRawJson(String str) =>
      WeightGroupDetailValue.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WeightGroupDetailValue.fromJson(Map<String, dynamic> json) =>
      WeightGroupDetailValue(
        id: json["id"],
