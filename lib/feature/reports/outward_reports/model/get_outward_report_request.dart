...
class GetOutwardReportRequest {
  ...
  DateTime? dateFrom;
  DateTime? dateTo;
  double? minGrossWeight;
  double? maxGrossWeight;
  double? minNetWeight;
  double? maxNetWeight;

  GetOutwardReportRequest({
    this.type,
    this.metalType,
    this.ornamentType,
    this.weightGroup,
  ...
  factory GetOutwardReportRequest.fromRawJson(String str) =>
      GetOutwardReportRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetOutwardReportRequest.fromJson(Map<String, dynamic> json) =>
      GetOutwardReportRequest(
        type: json["type"],
        ...
        minGrossWeight: json["min_gross_weight"]?.toDouble(),
        maxGrossWeight: json["max_gross_weight"]?.toDouble(),
        minNetWeight: json["min_net_weight"]?.toDouble(),
        maxNetWeight: json["max_net_weight"]?.toDouble(),
      );
