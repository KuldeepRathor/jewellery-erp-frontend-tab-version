...
class GetOutwardReportDetailRequest {
  ...
  factory GetOutwardReportDetailRequest.fromRawJson(String str) =>
      GetOutwardReportDetailRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetOutwardReportDetailRequest.fromJson(Map<String, dynamic> json) =>
      GetOutwardReportDetailRequest(
