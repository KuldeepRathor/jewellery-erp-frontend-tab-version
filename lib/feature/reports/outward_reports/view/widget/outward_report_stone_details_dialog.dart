...
class OutwardReportStoneDetailsDialog extends StatelessWidget {
  final List<GetOutwardReportStoneData>? stoneData;
  final GetOutwardReportStoneTotal? stoneTotal;

  const OutwardReportStoneDetailsDialog({
    super.key,
