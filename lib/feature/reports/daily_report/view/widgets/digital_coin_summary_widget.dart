...
class DigitalCoinSummaryWidget extends StatelessWidget {
  const DigitalCoinSummaryWidget({super.key});
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        _buildPurchaseCard(
                          'Sales (${purchase?.vendorPurchase?.invoiceCount ?? '0'})',
                        ...
                        _buildPurchaseCard(
                          'Exchange (${purchase?.customerPurchase?.invoiceCount ?? '0'})',
                        ...
                        _buildVerticalDivider(),
                        _buildPurchaseCard(
                          'Delivery (${purchase?.correctionWeight?.invoiceCount ?? '0'})',
