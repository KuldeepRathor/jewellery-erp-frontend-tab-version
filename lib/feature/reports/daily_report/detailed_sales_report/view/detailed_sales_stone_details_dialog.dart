...
class SalesRecordStoneDetailsDialog extends StatelessWidget {
  final List<SalesRecordDetailReportStoneData>? stoneData;
  final SalesRecordDetailReportStoneTotal? stoneTotal;

  const SalesRecordStoneDetailsDialog({
    super.key,
