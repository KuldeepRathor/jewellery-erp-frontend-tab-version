...
class StoneStatementReportRequest {
  ...
  factory StoneStatementReportRequest.fromRawJson(String str) =>
      StoneStatementReportRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory StoneStatementReportRequest.fromJson(Map<String, dynamic> json) =>
      StoneStatementReportRequest(
