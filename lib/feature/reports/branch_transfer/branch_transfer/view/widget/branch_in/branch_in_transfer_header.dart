...
class BranchInTransferHeader extends GetView<BranchInTransferViewModel> {
  const BranchInTransferHeader({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<BranchInTransferViewModel>(
      builder: (_) {
        return Container(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                _buildTransferFromDropdown(),
                const SizedBox(width: 8),
                _buildTransferByDropdown(),
                const Spacer(),
                SizedBox(width: Get.width * 0.03),
                _buildBranchOutFetchField(),
              ],
            ),
          ),
        );
  ...
  Widget _buildTransferFromDropdown() {
    return SizedBox(
      width: 250,
      child: Padding(
  ...
  Widget _buildBranchOutFetchField() {
    return SizedBox(
      width: 300,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
            ...
            children: [
              Expanded(
                ...
                child: CustomTextField(
                  controller: controller.branchOutDataFetchController,
                  borderColor: secondaryColor,
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return "Please Enter Branchout Number";
                    }
                    return null;
                  },
                ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (controller
                            .branchOutDataFetchController
                            .text
                            .isNotEmpty) {
                          controller.fetchBranchOutByNumber();
                        } else {
                          showErrorToast(
                            message: "Please enter a Branch Out number",
                          );
                        }
                      },
