...
import 'package:jewellery_erp_frontend_tab_version/feature/web_store/home_page/2x2_banner_upload/view_model/banner_twoxtwo_upload_controller.dart';
...
class BannerTwoXTwoUploadPage extends StatefulWidget {
  const BannerTwoXTwoUploadPage({super.key});

  @override
  State<BannerTwoXTwoUploadPage> createState() =>
      _BannerTwoXTwoUploadPageState();
}

class _BannerTwoXTwoUploadPageState extends State<BannerTwoXTwoUploadPage> {
  late final BannerTwoXTwoUploadController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(BannerTwoXTwoUploadController());
  }

  @override
  void dispose() {
    Get.delete<BannerTwoXTwoUploadController>();
    super.dispose();
  }
                  ...
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text("Loading 2x2 banner slides..."),
                      ],
                    ),
                  );
  ...
  Widget _buildSlideCard(
    ...
    BannerTwoXTwoUploadController controller,
  ...
  Widget _buildSaveButton(BannerTwoXTwoUploadController controller) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(8),
