...
import 'package:jewellery_erp_frontend_tab_version/feature/web_store/home_page/4x4_banner_upload/view_model/banner_fourxfour_upload_controller.dart';
...
class BannerFourXFourUploadPage extends StatefulWidget {
  const BannerFourXFourUploadPage({super.key});

  @override
  State<BannerFourXFourUploadPage> createState() =>
      _BannerFourXFourUploadPageState();
}

class _BannerFourXFourUploadPageState extends State<BannerFourXFourUploadPage> {
  late final BannerFourXFourUploadController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(BannerFourXFourUploadController());
  }

  @override
  void dispose() {
    Get.delete<BannerFourXFourUploadController>();
    super.dispose();
  }
              ...
              child: Obx(() {
                ...
                if (apiResponse.status == Status.LOADING ||
                  ...
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text("Loading 4x4 banner slides..."),
                      ],
                    ),
                  );
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      children: [
                        // Static slide cards (4)
                        Obx(() {
                          return Column(
                            children: [
                              // Slide 1 - Home Page Banner 1
                              _buildSlideCard(
                                context,
                                controller,
                                controller.slides[0],
  ...
  Widget _buildSlideCard(
    ...
    BannerFourXFourUploadController controller,
  ...
  Widget _buildSaveButton(BannerFourXFourUploadController controller) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(8),
