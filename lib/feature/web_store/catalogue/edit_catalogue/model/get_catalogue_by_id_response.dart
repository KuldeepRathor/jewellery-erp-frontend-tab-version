...
class GetCatalogueByIdResponse {
  String? id;
  ...
  factory GetCatalogueByIdResponse.fromRawJson(String str) =>
      GetCatalogueByIdResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetCatalogueByIdResponse.fromJson(Map<String, dynamic> json) =>
      GetCatalogueByIdResponse(
        id: json["id"],
