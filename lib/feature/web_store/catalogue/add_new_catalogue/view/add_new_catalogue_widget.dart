...
class AddNewCatalogueWidget extends StatelessWidget {
  const AddNewCatalogueWidget({super.key});
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          controller: catalogueController.minWeightController,
                          decoration: InputDecoration(
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                            ),
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          controller: catalogueController.maxWeightController,
                          decoration: InputDecoration(
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                            ),
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          controller: catalogueController.stoneWeightController,
                          decoration: InputDecoration(
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                            ),
                      ...
                      Obx(
                        () => Container(
                          ...
                          child: DropdownButton<String>(
                            value: catalogueController.stoneRateType.value,
                  ...
                  Obx(
                    () => Row(
                      children: [
                        Checkbox(
                          value:
                              catalogueController.isMandatoryDescription.value,
                          onChanged:
                              catalogueController.toggleMandatoryDescription,
                        ),
                          ...
                          () => ElevatedButton(
                            onPressed:
                                catalogueController.isUploading.value
                                    ? null
                                    : () => catalogueController.saveCatalogue(
                                      isEdit: false,
                                    ),
