...
import 'package:jewellery_erp_frontend_tab_version/feature/web_store/catalogue/add_new_catalogue/view/add_new_catalogue_widget.dart';
...
import 'package:jewellery_erp_frontend_tab_version/feature/web_store/catalogue/edit_catalogue/view/edit_catalogue_widget.dart';
...
class OrderToMakeListingPage extends StatefulWidget {
  const OrderToMakeListingPage({super.key});

  @override
  State<OrderToMakeListingPage> createState() => _OrderToMakeListingPageState();
}

class _OrderToMakeListingPageState extends State<OrderToMakeListingPage> {
          ...
          Expanded(
            child: Row(
              ...
              children: [
                ...
                // Add item section
                controller.editProductId.value.isNotEmpty
                    ? const Expanded(flex: 2, child: EditCatalogueWidget())
                    : Obx(
                      () => Visibility(
                        visible: controller.isAddWidgetVisible.value,
                        child: const Expanded(
                          flex: 2,
                          child: AddNewCatalogueWidget(),
                        ),
                      ),
                    ),
              ],
