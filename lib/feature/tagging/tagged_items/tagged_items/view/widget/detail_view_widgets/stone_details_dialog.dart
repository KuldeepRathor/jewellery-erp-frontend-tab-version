...
class StoneDetailsDialog extends StatelessWidget {
  final List<GetTaggedItemsByIdResponseStoneDataResponse>? stoneData;

  const StoneDetailsDialog({super.key, required this.stoneData});
