...
import 'package:jewellery_erp_frontend_tab_version/feature/tagging/tagged_items/tagged_items/view/widget/tagged_items_filter_widget.dart';
...
class TaggedItemsListingPage extends StatefulWidget {
  const TaggedItemsListingPage({super.key});

  @override
  State<TaggedItemsListingPage> createState() => _TaggedItemsListingPageState();
}

class _TaggedItemsListingPageState extends State<TaggedItemsListingPage> {
  final TaggedItemsListingViewModel controller = Get.put(
  ...
  void initState() {
    ...
    controller.getOrnamentsTypeListingDetails(resetList: true);
  ...
  Widget _buildOrnamentTypeTable(TaggedItemsListingViewModel controller) {
    return Expanded(
      child: Container(
