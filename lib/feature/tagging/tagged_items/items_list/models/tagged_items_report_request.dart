...
class GetTaggedItemsReportRequest {
  ...
  factory GetTaggedItemsReportRequest.fromRawJson(String str) =>
      GetTaggedItemsReportRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetTaggedItemsReportRequest.fromJson(Map<String, dynamic> json) =>
      GetTaggedItemsReportRequest(
