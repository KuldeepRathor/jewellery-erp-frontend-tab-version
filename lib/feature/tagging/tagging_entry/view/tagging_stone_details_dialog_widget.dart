...
import 'package:jewellery_erp_frontend_tab_version/feature/tagging/tagging_entry/view_model/tagging_stone_details_controller.dart';
...
class TaggingStoneDetailsDialog extends StatefulWidget {
  ...
  const TaggingStoneDetailsDialog({
    super.key,
  ...
  @override
  State<TaggingStoneDetailsDialog> createState() =>
      _TaggingStoneDetailsDialogState();
}

class _TaggingStoneDetailsDialogState extends State<TaggingStoneDetailsDialog> {
  final TaggingStoneDetailsController controller = Get.put(
    TaggingStoneDetailsController(),
  );
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              CustomText(
                text: _calculateAvailableStoneWeight(),
                fontSize: 14,
                fontWeight: FontWeight.w600,
              ),
            ],
  ...
  String _calculateAvailableStoneWeight() {
    if (widget.grossWeight == null || widget.netWeight == null) {
      return "-";
    }

    try {
      double grossWt = double.parse(widget.grossWeight!);
      double netWt = double.parse(widget.netWeight!);
      double availableStoneWt = grossWt - netWt;

      return availableStoneWt.toStringAsFixed(3);
    } catch (e) {
      return "-";
    }
  }
  ...
  void onStoneNameSelected({
    ...
    bool isDoth = selectedValue.code == "DOTH";
    if (isOthCode || isDoth) {
