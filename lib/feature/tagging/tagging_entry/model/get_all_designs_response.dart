...
class GetAllDesignsResponse {
  List<GetAllDesignsValue>? values;

  GetAllDesignsResponse({
    this.values,
  });

  factory GetAllDesignsResponse.fromRawJson(String str) =>
      GetAllDesignsResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllDesignsResponse.fromJson(Map<String, dynamic> json) =>
      GetAllDesignsResponse(
        values: json["values"] == null
            ? []
            : List<GetAllDesignsValue>.from(
                json["values"]!.map((x) => GetAllDesignsValue.fromJson(x))),
      );
...
class GetAllDesignsValue {
  ...
  factory GetAllDesignsValue.fromRawJson(String str) =>
      GetAllDesignsValue.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllDesignsValue.fromJson(Map<String, dynamic> json) =>
      GetAllDesignsValue(
        id: json["id"],
        code: json["code"],
        name: json["name"],
