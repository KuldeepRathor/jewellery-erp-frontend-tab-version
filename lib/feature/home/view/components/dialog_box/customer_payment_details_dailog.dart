...
import 'package:jewellery_erp_frontend_tab_version/feature/purchase/customer_purchase/view_model/customer_payment_details_controller.dart';
...
class CustomerPaymentDetailsDailog extends StatefulWidget {
  const CustomerPaymentDetailsDailog({super.key});

  @override
  State<CustomerPaymentDetailsDailog> createState() =>
      _CustomerPaymentDetailsDailogState();
}

class _CustomerPaymentDetailsDailogState
    extends State<CustomerPaymentDetailsDailog> {
  final CustomerPaymentDetailsController controller = Get.put(
    CustomerPaymentDetailsController(),
  );
