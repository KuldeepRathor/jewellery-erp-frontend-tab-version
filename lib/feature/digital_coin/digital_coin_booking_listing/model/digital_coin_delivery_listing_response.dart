...
class DigitalCoinDeliveryListingResponse {
  int? page;
  int? limit;
  int? totalResults;
  List<Result>? results;

  DigitalCoinDeliveryListingResponse({
    this.page,
    this.limit,
    this.totalResults,
    this.results,
  ...
  factory DigitalCoinDeliveryListingResponse.fromRawJson(String str) =>
      DigitalCoinDeliveryListingResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DigitalCoinDeliveryListingResponse.fromJson(
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        subTotal: (json["sub_total"] as num?)
            ?.toDouble(), // Handle numeric conversion
        quantity:
            (json["quantity"] as num?)?.toDouble(), // Handle numeric conversion
