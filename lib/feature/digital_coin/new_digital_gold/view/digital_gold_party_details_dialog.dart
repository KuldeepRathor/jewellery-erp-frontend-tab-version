...
class DigitalGoldPartyDetailsWidget extends StatelessWidget {
  DigitalGoldPartyDetailsWidget({
    super.key,
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  //         buttonName: planController.isVerified.value
                  //             ? "Verified"
                  //             : "Verify",
                  //         onTap: () {
                  //           if (controller
                  //               .searchController.value.text.isNotEmpty) {
                  //             planController.setSearchQuery(
