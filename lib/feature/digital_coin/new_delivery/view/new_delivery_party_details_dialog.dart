...
class NewDeliveryPartyDetailsWidget extends StatelessWidget {
  NewDeliveryPartyDetailsWidget({
    super.key,
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Obx(
                      () => CustomButton1(
                        buttonName:
                            newDeliveryController.isVerified.value
                                ? "Verified"
                                : "Verify",
                        onTap: () {
                          if (controller.selectedParty.value != null &&
                            ...
                            if (customerPhone != null &&
                              ...
                              newDeliveryController.verifyUser(customerPhone);
                            } else {
                              showErrorToast(
                                message:
