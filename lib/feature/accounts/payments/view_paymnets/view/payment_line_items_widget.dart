...
class PaymentLineItemsWidget extends StatelessWidget {
  final List<LineItem> lineItems;
  final PartyDetails? partyDetails;

  const PaymentLineItemsWidget({
    super.key,
  ...
  static final Map<int, TableColumnWidth> totalColumnWidths = {
    0: const FlexColumnWidth(12), // Adjust this to include Sn + Party Name
    1: const FlexColumnWidth(0.4), // Payment No.
    2: const FlexColumnWidth(2000),
