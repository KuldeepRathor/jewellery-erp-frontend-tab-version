...
class GetPaymentsByIdResponse {
  ...
  factory GetPaymentsByIdResponse.fromRawJson(String str) =>
      GetPaymentsByIdResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetPaymentsByIdResponse.fromJson(Map<String, dynamic> json) =>
      GetPaymentsByIdResponse(
        id: json["id"],
