...
class AccountsPaymentLineItemTableWidget extends StatelessWidget {
  final AccountsPaymentLineItemController controller = Get.find();

  AccountsPaymentLineItemTableWidget({super.key});
  ...
  List<TableRow> _buildRows() {
    log("The items list is ${controller.items.length}");
