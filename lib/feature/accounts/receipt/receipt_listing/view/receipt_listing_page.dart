...
import 'package:jewellery_erp_frontend_tab_version/feature/accounts/receipt/receipt_listing/view_model/receipt_listing_view_model.dart';
...
class ReceiptListingPage extends StatefulWidget {
  const ReceiptListingPage({super.key});

  @override
  State<ReceiptListingPage> createState() => _ReceiptListingPageState();
}

class _ReceiptListingPageState extends State<ReceiptListingPage> {
  // final controller =
  //     Get.put<ReceiptListingViewModel>(ReceiptListingViewModel());
  final ReceiptListingViewModel controller = Get.put(ReceiptListingViewModel());
  final ScrollController _scrollController = ScrollController();
  @override
  void initState() {
    super.initState();
    controller.setInitialConditions(isSearch: false);
    controller.getReceiptListingDetails(resetList: true);
    ...
    return Scaffold(
      ...
      body: ActionScopeWidget(
        ...
        child: Column(
          ...
          children: [
            HeaderWidget(header: 'Receipt List'),
            Expanded(
              child: Padding(
  ...
  Widget _buildCustomerTable(ReceiptListingViewModel controller) {
    return Expanded(
      child: Container(
  ...
  Widget _buildTableStates() {
    return Obx(() {
      final apiStatus = controller.receiptListingResponse.value.status;
      log("API Status: $apiStatus");
      if (apiStatus == Status.COMPLETED) {
        final data = controller.receiptListingResponse.value.data;
        ...
        return Column(
          children: [
            ...
            Expanded(
              child: Center(
                child: Text(
                  controller.receiptListingResponse.value.message ??
