...
import 'package:jewellery_erp_frontend_tab_version/feature/accounts/receipt/view_receipt/view/receipts_details_info_widget.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/accounts/receipt/view_receipt/view/receipts_line_items_widget.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/accounts/receipt/view_receipt/view_model/view_receipts_controller.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/home/view_model/sidebar_controller.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/purchase/purchase_create/view/header_widget.dart';
import 'package:jewellery_erp_frontend_tab_version/res/colors/app_color.dart';

class ViewReceiptPage extends StatefulWidget {
  const ViewReceiptPage({super.key, required this.id});
  final String id;
  @override
...
class _ViewReceiptPageState extends State<ViewReceiptPage> {
  final ViewReceiptsController viewPaymentsController = Get.put(
    ViewReceiptsController(),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ReceiptsDetailsInfoWidget(data: widget.data),
        Expanded(
          child: Padding(
              ...
              children: [
                Container(
                  ...
                  child: TabBar(
                    ...
                    tabs: const [
                      Tab(text: 'Receipt Items'),
                      Tab(text: 'Receipt Details'),
                    ],
                  ),
                ),
                Expanded(
...
// Create a ReceiptSummaryWidget for the second tab
class ReceiptSummaryWidget extends StatelessWidget {
  final GetReceiptsByIdResponse data;

  const ReceiptSummaryWidget({super.key, required this.data});
