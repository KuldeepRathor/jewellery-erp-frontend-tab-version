...
import 'package:jewellery_erp_frontend_tab_version/feature/accounts/receipt/create_receipt/view/widgets/account_receipt_details_widget.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/accounts/receipt/create_receipt/view/widgets/account_receipt_line_item_table_widget.dart';
import 'package:jewellery_erp_frontend_tab_version/feature/accounts/receipt/create_receipt/view/widgets/account_receipt_payment_details_dialog.dart';
...
// Then update the AccountsReceiptPage class
class AccountsReceiptPage extends StatefulWidget {
  const AccountsReceiptPage({super.key, this.partyDetails});
  final dynamic partyDetails; // Can be CustomerSearchValue or VendorSearchValue

  @override
  State<AccountsReceiptPage> createState() => _AccountsReceiptPageState();
}

class _AccountsReceiptPageState extends State<AccountsReceiptPage> {
  final AccountReceiptViewmodel accountPaymentViewmodel = Get.put(
    AccountReceiptViewmodel(),
  );
  final AccountReceiptPaymentDetailsController accountPaymentDetailsController =
      Get.put(AccountReceiptPaymentDetailsController());

  final AccountsReceiptLineItemController controller = Get.put(
    AccountsReceiptLineItemController(),
  );
  ...
  void _showPaymentDetailsDialog() {
    ...
    Get.dialog(const AccountReceiptPaymentDetailsDialog());
  }
  ...
  void initState() {
    ...
    accountPaymentViewmodel.fetchReceiptNumber();
          ...
          child: Scaffold(
            body: Column(
              children: [
                ...
                const AccountReceiptDetailsWidget(),
                Expanded(child: AccountsReceiptLineItemTableWidget()),
                _footerWidget(),
              ],
            ),
          ),
