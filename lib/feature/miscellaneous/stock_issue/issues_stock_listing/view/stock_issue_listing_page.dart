...
import 'package:jewellery_erp_frontend_tab_version/feature/miscellaneous/stock_issue/issues_stock_listing/view_model/stock_issue_controller.dart';
...
class StockIssueListingPage extends StatefulWidget {
  const StockIssueListingPage({super.key});

  @override
  State<StockIssueListingPage> createState() => _StockIssueListingPageState();
}

class _StockIssueListingPageState extends State<StockIssueListingPage> {
  final StockIssueController controller = Get.put(StockIssueController());
  ...
  Widget build(BuildContext context) {
    return ActionScopeWidget(
      onNewButtonTap: () {
        PermissionGuardUtil.withActionPermission(5152, () {
  ...
  Widget _buildApprovalListTable(StockIssueController controller) {
    return Expanded(
      child: Container(
